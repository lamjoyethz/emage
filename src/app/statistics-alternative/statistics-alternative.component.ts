...
@Component({
  selector: 'app-statistics-alternative',
  templateUrl: './statistics-alternative.component.html',
  styleUrls: ['./statistics-alternative.component.scss'],
})
export class StatisticsAlternativeComponent implements OnInit {
